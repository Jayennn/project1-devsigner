    ...
    return (
        <section className={"bg-themeBlue py-12"}>
            <div className={"container"}>
                <div className={"w-full flex flex-col md:flex-row md:justify-between text-white pb-24"}>
                    <Typography variant={"h1"} className={"text-white md:max-w-xs"}>About our company</Typography>
